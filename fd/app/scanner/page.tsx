...
import { Camera, Check, ScanFace, ShieldCheck, ShieldX, VideoOff, X } from "lucide-react"
    ...
    <main className="mx-auto grid w-full max-w-6xl flex-1 gap-6 px-6 py-10 lg:grid-cols-[1fr_360px]">
      <section className="space-y-4">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-sm uppercase tracking-widest text-muted-foreground">Скан</p>
            <h1 className="mt-1 text-2xl font-light tracking-tight">Хаалганы скан</h1>
        ...
        <Card className="overflow-hidden">
          <div className="relative aspect-video bg-zinc-950">
            {state.kind === "matched" || state.kind === "no-match" || state.kind === "matching" ? (
              <img
                src={state.kind !== "matching" || state.capture ? state.capture : ""}
                alt="Scan capture"
            ...
            <CardContent className="flex items-center gap-4 p-4">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  <h3 className="font-medium">{state.ticket.buyer.fullName}</h3>
            ...
            <CardContent className="flex items-center justify-between gap-4 p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Үзэгчийг кассын лангуу руу чиглүүлж дахин бүртгүүлэх эсвэл буцаалт хийнэ үү.
                  </p>
                </div>
              </div>
      ...
      <aside>
        <Card className="sticky top-20">
          <CardContent className="space-y-3 p-5">
            ...
            <p className="text-xs text-muted-foreground">
              Сүүлд бүртгүүлсэн царайнууд. Скан хамгийн ойролцоо тохирлыг буцаана.
            </p>
              ...
              {tickets.slice(0, 8).map((t) => (
                <li key={t.id} className="flex items-center gap-3 rounded-md border p-2">
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="truncate text-sm font-medium">{t.buyer.fullName}</p>
                    <p className="truncate text-xs text-muted-foreground">{t.eventTitle}</p>
                  </div>
